...
class MyCanvas(QtOpenGL.QGLWidget):
    ...
    def paintGL(self):
        ...
        if len(self.m_hmodel.gridPoints) > 0:
            for point in self.m_hmodel.gridPoints:
    ...
    def mouseMoveEvent(self, event):
        if self.m_buttonPressed or self.m_fence:
            self.m_pt1 = event.pos()
            self.update()
    ...
    def mouseReleaseEvent(self, event):
        ...
        if event.button() == 1:
            ...
            if len(self.m_hmodel.gridPoints) > 0:
                for point in self.m_hmodel.gridPoints:
                    x, y = point.getX(), point.getY()
                    condition1 = (pt0_U.x() < x < pt1_U.x()) and (pt0_U.y() < y < pt1_U.y())
                    condition2 = (pt0_U.x() < x < pt1_U.x()) and (pt0_U.y() > y > pt1_U.y())
                    condition3 = (pt0_U.x() > x > pt1_U.x()) and (pt0_U.y() > y > pt1_U.y())
                    condition4 = (pt0_U.x() > x > pt1_U.x()) and (pt0_U.y() < y < pt1_U.y())
